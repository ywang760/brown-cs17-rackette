...
function emptyP(va) {
  ...
  var match = va.hd;
  if (match.TAG === /* ListV */2 && !(match._0 || va.tl)) {
    return {
            TAG: /* BoolV */1,
            _0: true
          };
              ...
              switch (n$1) {
                          ...
                          if (match$15 && !match$15.tl) {
                            return {
                                    ...
                                    _0: {
                                      ...
                                      letBody: parseExpression(match$15.hd)
                                    }
                                  };
                          } else {
                            return Pervasives.failwith("Let needs to take in a list of pairs and an expression");
                ...
                case "or" :
                    ...
                    if (match$17 && !match$17.tl) {
                      return {
                              TAG: /* OrE */4,
                              _0: parseExpression(match$16.hd),
                              _1: parseExpression(match$17.hd)
                            };
                    } else {
                      return Pervasives.failwith("Or needs to take in two expressions");
                    }
...
CS17SetupRackette$Rackette.checkExpectAbstractProgram(List.map(parsePiece, Read$Rackette.Reader.readAll("(define lengthen2 (lambda (alon) (cons 9 alon))) (lengthen2 (list 2 3))")), {
      hd: {
        TAG: /* Definition */0,
        _0: [
          /* Name */{
...
CS17SetupRackette$Rackette.checkExpectAbstractProgram(List.map(parsePiece, Read$Rackette.Reader.readAll("(define flip (lambda (alops) (cond ((empty? alops) empty) ((cons? alops) (cons (list (second (first alops)) (first (first alops))) (flip (rest alops)))))))")), {
      hd: {
        TAG: /* Definition */0,
        _0: [
          /* Name */{
...
CS17SetupRackette$Rackette.checkExpect(stringOfValue($$eval(initialTle, /* [] */0, parseExpression(Read$Rackette.Reader.read("(let ((x 0) (y 18)) (let ((f (lambda (a b) (+ x b ))) (x 17)) (f y x)))")))), "17", "read and parseExpression and eval and stringOfValue with let and nested lambda within let");
